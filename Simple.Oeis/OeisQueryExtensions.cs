...
public static class OeisQueryExtensions
{
    ...
    public static Task<IReadOnlyList<IOeisSequence>> QuerySequences<T>(this IOeisQuery query,
        params IEnumerable<T> sequence)
    ...
    public static Task<IOeisSequence> QuerySequence(this IOeisQuery query, ReadOnlySpan<char> name,
    ...
    /// <param name="token">Token to cancel operation</param>
    /// <returns>OEIS sequence</returns>
    public static Task<IOeisSequence> QuerySequence(this IOeisQuery query, string name,
        CancellationToken token = default)
    {
        ArgumentNullException.ThrowIfNull(query);
